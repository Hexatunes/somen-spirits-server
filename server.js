...
io.on('connection', (socket) => {
  ...
  socket.on('next_turn', (sentBATTLE_ID) => {
    ...
    if (turnOrder[0]["UID"] == p1UID) {
      ...
      if (p1Team[0]["order"] == turnOrder[0]["order"]) {
        actingIDX = 0
      }

      if (p1Team[1]["order"] == turnOrder[0]["order"]) {
        actingIDX = 1
      }

      if (p1Team[2]["order"] == turnOrder[0]["order"]) {
        actingIDX = 2
      }
      ...
      if (p2Team[0]["order"] == turnOrder[0]["order"]) {
        actingIDX = 0
      }

      if (p2Team[1]["order"] == turnOrder[0]["order"]) {
        actingIDX = 1
      }

      if (p2Team[2]["order"] == turnOrder[0]["order"]) {
        actingIDX = 2
      }
    ...
    if ( targetSide == 1 && p2Team[actingIDX]["charging"] == "chargING") {
      //Update turn order
      ...
      return
    } else if (targetSide == 2 && p1Team[actingIDX]["charging"] == "chargING") {
      //Update turn order
    ...
    switch (choice) {
      ...
      case "soultimate":
        ...
        if ( SOULTIMATE_DATABASE[turnOrder[0]["soult"]]["targets"] == "allEnemy") {
          for (var x = 0; x < 3; x++){
            for (var i = 0; i < SOULTIMATE_DATABASE[turnOrder[0].soult].hits; i++) {


              var bp = SOULTIMATE_DATABASE[turnOrder[0].soult].bp
              var element = SOULTIMATE_DATABASE[turnOrder[0].soult].element

              d1 = soultimate(p1Team, p2Team, targetSide, x, turnOrder)
              finalDamage += d1[0]
              crits += d1[1]
              misses += d1[2]
            ...
            if (targetSide == 1) {
              ...
              p1.emit("soultimate_used", { myTeam: p1Team, otherTeam: p2Team, chatMessage: "Opponent's " + turnOrder[0]["displayName"] + " used <em id = 'soult'>" + SOULTIMATE_DATABASE[turnOrder[0]["soult"]]["displayName"] + "</em id = 'soult'> on your " + p1Team[x]["displayName"] + "! Damage: <em id = 'damage'>" + finalDamage + "</em id = 'damage'> (<em id = 'damage'>" + (Math.floor(finalDamage / p1Team[x]["hp"] * 100)) + "</em id = 'damage'>%)", crits: crits, misses: misses, soult: turnOrder[0]["soult"] })
              p2.emit("soultimate_used", { myTeam: p2Team, otherTeam: p1Team, chatMessage: "Your " + turnOrder[0]["displayName"] + " used <em id = 'soult'>" + SOULTIMATE_DATABASE[turnOrder[0]["soult"]]["displayName"] + "</em id = 'soult'> on the opponent's " + p1Team[x]["displayName"] + "! Damage: <em id = 'damage'>" + finalDamage + "</em id = 'damage'> (<em id = 'damage'>" + (Math.floor(finalDamage / p1Team[x]["hp"] * 100)) + "</em id = 'damage'>%)", crits: crits, misses: misses, soult: turnOrder[0]["soult"] })
            } else {
              p2Team[x]["currentHP"] -= finalDamage
              turnOrder[0]["charging"] = "none"
              turnOrder[0]["soul"] = 0

              p1.emit("soultimate_used", { myTeam: p1Team, otherTeam: p2Team, chatMessage: "Your " + turnOrder[0]["displayName"] + " used <em id = 'soult'>" + SOULTIMATE_DATABASE[turnOrder[0]["soult"]]["displayName"] + "</em id = 'soult'> on the opponent's " + p2Team[x]["displayName"] + "! Damage: <em id = 'damage'>" + finalDamage + "</em id = 'damage'> (<em id = 'damage'>" + (Math.floor(finalDamage / p2Team[x]["hp"] * 100)) + "</em id = 'damage'>%)", crits: crits, misses: misses, soult: turnOrder[0]["soult"] })
              p2.emit("soultimate_used", { myTeam: p2Team, otherTeam: p1Team, chatMessage: "Opponent's " + turnOrder[0]["displayName"] + " used <em id = 'soult'>" + SOULTIMATE_DATABASE[turnOrder[0]["soult"]]["displayName"] + "</em id = 'soult'> on your " + p2Team[x]["displayName"] + "! Damage: <em id = 'damage'>" + finalDamage + "</em id = 'damage'> (<em id = 'damage'>" + (Math.floor(finalDamage / p2Team[x]["hp"] * 100)) + "</em id = 'damage'>%)", crits: crits, misses: misses, soult: turnOrder[0]["soult"] })
            }
          }
          ...
          for (var i = 0; i < SOULTIMATE_DATABASE[turnOrder[0].soult].hits; i++) {
            ...
            d1 = soultimate(p1Team, p2Team, targetSide, targetIDX, turnOrder)
            finalDamage += d1[0]
            crits += d1[1]
            misses += d1[2]
          ...
          if (targetSide == 1) {
            ...
            p1.emit("soultimate_used", { myTeam: p1Team, otherTeam: p2Team, chatMessage: "Opponent's " + turnOrder[0]["displayName"] + " used <em id = 'soult'>" + SOULTIMATE_DATABASE[turnOrder[0]["soult"]]["displayName"] + "</em id = 'soult'> on your " + p1Team[targetIDX]["displayName"] + "! Damage: <em id = 'damage'>" + finalDamage + "</em id = 'damage'> (<em id = 'damage'>" + (Math.floor(finalDamage / p1Team[targetIDX]["hp"] * 100)) + "</em id = 'damage'>%)", crits: crits, misses: misses, soult: turnOrder[0]["soult"] })
            p2.emit("soultimate_used", { myTeam: p2Team, otherTeam: p1Team, chatMessage: "Your " + turnOrder[0]["displayName"] + " used <em id = 'soult'>" + SOULTIMATE_DATABASE[turnOrder[0]["soult"]]["displayName"] + "</em id = 'soult'> on the opponent's " + p1Team[targetIDX]["displayName"] + "! Damage: <em id = 'damage'>" + finalDamage + "</em id = 'damage'> (<em id = 'damage'>" + (Math.floor(finalDamage / p1Team[targetIDX]["hp"] * 100)) + "</em id = 'damage'>%)", crits: crits, misses: misses, soult: turnOrder[0]["soult"] })
          } else {
            p2Team[targetIDX]["currentHP"] -= finalDamage
            turnOrder[0]["charging"] = "none"
            turnOrder[0]["soul"] = 0

            p1.emit("soultimate_used", { myTeam: p1Team, otherTeam: p2Team, chatMessage: "Your " + turnOrder[0]["displayName"] + " used <em id = 'soult'>" + SOULTIMATE_DATABASE[turnOrder[0]["soult"]]["displayName"] + "</em id = 'soult'> on the opponent's " + p2Team[targetIDX]["displayName"] + "! Damage: <em id = 'damage'>" + finalDamage + "</em id = 'damage'> (<em id = 'damage'>" + (Math.floor(finalDamage / p2Team[targetIDX]["hp"] * 100)) + "</em id = 'damage'>%)", crits: crits, misses: misses, soult: turnOrder[0]["soult"] })
            p2.emit("soultimate_used", { myTeam: p2Team, otherTeam: p1Team, chatMessage: "Opponent's " + turnOrder[0]["displayName"] + " used <em id = 'soult'>" + SOULTIMATE_DATABASE[turnOrder[0]["soult"]]["displayName"] + "</em id = 'soult'> on your " + p2Team[targetIDX]["displayName"] + "! Damage: <em id = 'damage'>" + finalDamage + "</em id = 'damage'> (<em id = 'damage'>" + (Math.floor(finalDamage / p2Team[targetIDX]["hp"] * 100)) + "</em id = 'damage'>%)", crits: crits, misses: misses, soult: turnOrder[0]["soult"] })
          }
        }
  ...
  socket.on('cast_soult', (sentBATTLE_ID, sentUID, sentIDX) => {
    var myTeam
    var otherTeam
...
function soultimate(p1Team, p2Team, targetSide, targetIDX, turnOrder) {
